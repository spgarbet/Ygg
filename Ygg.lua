...
local function add_mpe_params()
  ...
  mpe_params:add_option("ygg_mpe_mod", "MPE Mod", mpe_mod_labels, 2)
  mpe_params:add
  {
    type        = "control",
    id          = "ygg_mpe_press",
...
function enc(n, d)
  ...
  if pname == 'MPE' then
    ...
    elseif n == 3 then
      ...
      if sel == 1 then
        mpe_params:delta("ygg_mpe_vibrato", d)
      elseif sel == 2 then
        mpe_params:delta("ygg_mpe_bend", d)
      elseif sel == 3 then
